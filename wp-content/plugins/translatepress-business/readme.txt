...
== Changelog ==
= 1.8.4 =
* Added filter on machine translated slug

= 1.8.3 =
* Fix issue with Elementor websites language switcher not working correctly with Different Domain per Language addon.
...
* Improved handling of possible errors resulted from API calls that retrieved DeepL supported languages list
* Fix Elementor language switcher links getting replaced with the current domain

= 1.7.9 =
* Fixed issue regarding inserting translated slugs as originals. Prevent attachment slugs from being machine translated
* Fixed CORS on Elementor fonts, post CSS, and widget HTML for Different Domain per Language
