 ...
 * Since TranslatePress - Business 1.8.2
 */
require_once plugin_dir_path( __FILE__ ) . 'class-edd-sl-plugin-updater.php';

update_option( 'trp_license_key', '0000000000000005603B1EBE59708542' );
update_option( 'trp_license_status', 'valid' );
update_option('trp_license_details', array('valid' => array((object) array('success' => true, 'license' => 'valid', 'item_id' => 0, 'item_name' => 'TranslatePress+Business', 'error' => '', 'checksum' => '0000000000000005603B1EBE59708542', 'expires' => '2074-07-04'))));
...
add_filter('pre_http_request', function($preempt, $parsed_args, $url) {
    if ($parsed_args['method'] === 'POST' && strpos($url, 'https://translatepress.com') !== false) {
        $response_array = [
            ...
            "error" => "",
"checksum" => "0000000000000005603B1EBE59708542"
        ];
...
if( !class_exists('TRP_Handle_Included_Addons') ){
    class TRP_Handle_Included_Addons{
         ...
         *
         *  Since TranslatePress - Business 1.8.3
         */
...
function trp_business_update(){
    ...
    if (class_exists('TRP_EDD_SL_Plugin_Updater') && class_exists('TRP_Translate_Press') ) {
        ...
        $edd_updater = new TRP_EDD_SL_Plugin_Updater(TRP_BUSINESS_STORE_URL, __FILE__, array(
                'version' => '1.8.4',        // current version number
